...
CREATE TABLE empleado (
  ...
  CONSTRAINT PK_Empleado_Codigo_empleado PRIMARY KEY (codigo_empleado),
...
CREATE TABLE cliente (
  ...
  CONSTRAINT FK_Cliente_Codigo_empleado_rep_ventas FOREIGN KEY (codigo_empleado_rep_ventas) REFERENCES empleado (codigo_empleado)
);
...
CREATE TABLE pedido (
  ...
  CONSTRAINT FK_Pedido_Codigo_cliente FOREIGN KEY (codigo_cliente) REFERENCES cliente (codigo_cliente)
);
...
CREATE TABLE detalle_pedido (
  ...
  CONSTRAINT PK_Detalle_pedido_Compuesta PRIMARY KEY (codigo_pedido, codigo_producto),
  CONSTRAINT FK_Detalle_pedido_Codigo_pedido FOREIGN KEY (codigo_pedido) REFERENCES pedido (codigo_pedido),
  CONSTRAINT FK_Detalle_pedido_Codigo_producto FOREIGN KEY (codigo_producto) REFERENCES producto (codigo_producto)
);
...
CREATE TABLE pago (
  ...
  CONSTRAINT PK_Pago_Compuesta PRIMARY KEY (codigo_cliente, id_transaccion),
